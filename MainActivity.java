...
public class MainActivity extends AppCompatActivity {
    ...
    public void updatenewDJVotes() {
        chooseDJRef.setValue(djVotes + 1);
    }
    ...
    public void createNewDJReader() {
        skipRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Integer value = dataSnapshot.getValue(Integer.class);
                djVotes = value;
                Log.d(TAG, "NewDJ votes value is: " + djVotes);
            }

            @Override
            public void onCancelled(DatabaseError error) {
                // Failed to read value
                Log.w(TAG, "Failed to read djVotes value.", error.toException());
            }
        });
    }
